...
class InvertedIndex:
    ...
    def __init__(self):
        self.pages_folder_name = path.join(dirname(__file__), 'pages')
        self.lemmas_file_name = path.join(dirname(__file__), 'lemmas.txt')
        self.inverted_index_file_name = path.join(dirname(__file__), 'inverted_index.txt')
